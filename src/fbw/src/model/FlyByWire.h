...
typedef struct {
  ...
  real_T Delay_DSTATE_d5;
  real_T Delay1_DSTATE_e;
  real_T Delay_DSTATE_oz;
  real_T Delay_DSTATE_pj;
...
struct Parameters_FlyByWire_T_ {
  ...
  real_T RateLimiterVariableTs1_InitialCondition_c;
