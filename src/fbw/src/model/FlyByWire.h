...
struct Parameters_FlyByWire_T_ {
  ...
  real_T Gain6_Gain;
  real_T Gain_Gain_cd;
  real_T Delay_InitialCondition_hg;
  ...
  real_T Delay1_InitialCondition_i1;
  real_T Gain4_Gain_o;
  real_T Gain7_Gain;
