...
void FlyByWireModelClass::step()
{
  ...
  rtb_Compare = ((FlyByWire_U.in.data.autopilot_master_on != 0.0) || (FlyByWire_U.in.data.slew_on != 0.0) ||
  ...
  FlyByWire_DWork.Delay1_DSTATE = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_l - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE + (rtb_GainTheta + FlyByWire_DWork.Delay_DSTATE_d) * (rtb_Limiterxi / rtb_Limiterxi1);
  ...
  rtb_Limiterxi1 = FlyByWire_U.in.data.autopilot_custom_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_j;
  ...
  rtb_Limiterxi1 = Theta - FlyByWire_DWork.Delay_DSTATE_c;
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch1_Threshold) {
    rtb_Sum5 = (FlyByWire_DWork.Delay_DSTATE_j - rtb_GainTheta) * FlyByWire_P.Gain4_Gain;
  } else {
    ...
    if (FlyByWire_DWork.Delay_DSTATE_c <= rtb_Saturation2) {
      ...
      if (FlyByWire_DWork.Delay_DSTATE_c >= rtb_Saturation2) {
        rtb_Saturation2 = FlyByWire_DWork.Delay_DSTATE_c;
      }
    }
  ...
  rtb_Limiterxi = (rtb_Gain1_b - FlyByWire_DWork.Delay_DSTATE_p) / FlyByWire_U.in.time.dt + rtb_Limiterxi *
  ...
  if (FlyByWire_DWork.Delay_DSTATE_e > FlyByWire_P.Saturation_UpperSat_dx) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_dx;
  } else if (FlyByWire_DWork.Delay_DSTATE_e < FlyByWire_P.Saturation_LowerSat_k) {
  ...
  rtb_Limitereta = FlyByWire_P.Constant_Value_jv - rtb_Limitereta;
  ...
  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_m - FlyByWire_DWork.Delay_DSTATE_f5;
  ...
  FlyByWire_DWork.Delay_DSTATE_f5 += rtb_Limiterxi1;
  ...
  rtb_Limiterxi1 = rtb_Limitereta - FlyByWire_DWork.Delay_DSTATE_fb;
  ...
  FlyByWire_DWork.Delay_DSTATE_fb += rtb_Limiterxi1;
  ...
  FlyByWire_DWork.Delay1_DSTATE_b = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_c - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_b + (rtb_Sum_k + FlyByWire_DWork.Delay_DSTATE_k) * (rtb_Limiterxi / rtb_Limiterxi1);
  rtb_Product_g = FlyByWire_DWork.Delay1_DSTATE_b * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
  ...
  rtb_Limitereta = rtb_Limiterxi1 * FlyByWire_DWork.Delay_DSTATE_fb;
  rtb_Limiterxi1 = FlyByWire_U.in.data.autopilot_custom_Phi_c_deg - FlyByWire_DWork.Delay_DSTATE_b;
  ...
  if ((FlyByWire_DWork.Delay_DSTATE_fb == 0.0) || (rtb_BusAssignment_a_sim_data_computed_tracking_mode_on != 0) ||
  ...
  rtb_Limiterxi1 = rtb_Saturation2 - FlyByWire_DWork.Delay_DSTATE_bo;
  ...
  FlyByWire_DWork.Delay_DSTATE_bo += rtb_Limiterxi1;
  rtb_Limiterxi1 = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_d;
  rtb_Sum5 = rtb_Limiterxi1 + FlyByWire_P.Constant_Value_m4;
  FlyByWire_DWork.Delay1_DSTATE_k = 1.0 / rtb_Sum5 * (FlyByWire_P.Constant_Value_m4 - rtb_Limiterxi1) *
    FlyByWire_DWork.Delay1_DSTATE_k + (rtb_Gain + FlyByWire_DWork.Delay_DSTATE_l) * (rtb_Limiterxi1 / rtb_Sum5);
  ...
  rtb_BusAssignment_e_roll_law_normal_xi_deg = ((FlyByWire_P.Gain3_Gain_k * FlyByWire_DWork.Delay_DSTATE_bo +
    FlyByWire_DWork.Delay_DSTATE_h) - rtb_GainPhi) * FlyByWire_P.Gain2_Gain_i + FlyByWire_P.Gain1_Gain_mg * result[0] *
  ...
  rtb_Sum1_aj = FlyByWire_P.Constant_Value_ma - rtb_Limitereta;
  rtb_Limiterxi = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_c;
  rtb_Limiterxi1 = rtb_Limiterxi + FlyByWire_P.Constant_Value_o;
  FlyByWire_DWork.Delay1_DSTATE_c = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_o - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_c + (FlyByWire_U.in.data.beta_deg + FlyByWire_DWork.Delay_DSTATE_db) * (rtb_Limiterxi /
    rtb_Limiterxi1);
  ...
  if (rtb_AND) {
    ...
    rtb_Limitereta = FlyByWire_DWork.Delay1_DSTATE_c;
  }
  ...
  rtb_Limiterxi1 = (rtb_Limiterxi + FlyByWire_DWork.Delay_DSTATE_g) - FlyByWire_DWork.Delay_DSTATE_n;
  ...
  rtb_Limiterxi1 = (FlyByWire_DWork.Delay1_DSTATE_k - std::sin(FlyByWire_P.Gain1_Gain_br *
    FlyByWire_DWork.Delay_DSTATE_h) * FlyByWire_P.Constant2_Value_l * std::cos(FlyByWire_P.Gain1_Gain_c * rtb_GainTheta)
  ...
  rtb_Limitereta = ((rtb_Sum1_aj * FlyByWire_DWork.Delay_DSTATE_n + rtb_Sum5) * rtb_Limitereta +
                    (FlyByWire_P.Constant_Value_d - rtb_Limitereta) * FlyByWire_P.Constant3_Value) +
    ((FlyByWire_DWork.Delay_DSTATE_bo + rtb_Limiterxi1) * FlyByWire_DWork.Delay_DSTATE_fb + rtb_Limiterxi);
  ...
  rtb_Sum1_aj = rtb_Limitereta;
  rtb_Limiterxi = FlyByWire_DWork.Delay_DSTATE_fb + FlyByWire_U.in.data.autopilot_custom_on;
  ...
  if (rtb_Limitereta > FlyByWire_P.Saturation_UpperSat_h) {
    ...
    if (rtb_Limitereta < FlyByWire_P.Saturation_LowerSat_kv) {
      rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_kv;
    }
  }
  ...
  rtb_Limiterxi = rtb_Sum1_aj * rtb_Limitereta;
  ...
  rtb_Limiterxi1 = rtb_Sum5 - FlyByWire_DWork.Delay_DSTATE_cw;
  ...
  FlyByWire_DWork.Delay_DSTATE_cw += rtb_Limiterxi1;
  ...
  FlyByWire_Y.out.pitch.data_computed.eta_trim_deg_reset = rtb_Compare;
  ...
  FlyByWire_Y.out.pitch.output.eta_trim_deg = FlyByWire_DWork.Delay_DSTATE_f5;
  ...
  FlyByWire_Y.out.roll.data_computed.in_flight_gain = FlyByWire_DWork.Delay_DSTATE_fb;
  ...
  FlyByWire_Y.out.roll.law_normal.zeta_deg = rtb_Sum1_aj;
  ...
  rtb_Limiterxi1 = FlyByWire_P.GainiH_Gain * FlyByWire_DWork.Delay_DSTATE_f5;
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gainxi_Gain_n * FlyByWire_DWork.Delay_DSTATE_cw;
  ...
  FlyByWire_DWork.Delay_DSTATE_d = rtb_GainTheta;
  FlyByWire_DWork.Delay_DSTATE_p = rtb_Gain1_b;
  FlyByWire_DWork.icLoad = 0U;
  FlyByWire_DWork.icLoad_b = 0U;
  FlyByWire_DWork.Delay_DSTATE_k = rtb_Sum_k;
...
void FlyByWireModelClass::initialize()
{
  ...
  FlyByWire_DWork.Delay_DSTATE_d = FlyByWire_P.Delay_InitialCondition_a;
  ...
  FlyByWire_DWork.Delay_DSTATE_j = FlyByWire_P.RateLimiterVariableTs1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_c = FlyByWire_P.RateLimiterVariableTs_InitialCondition_c;
  FlyByWire_DWork.Delay_DSTATE_p = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition;
  FlyByWire_DWork.icLoad = 1U;
  FlyByWire_DWork.Delay_DSTATE_f5 = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i;
  FlyByWire_DWork.icLoad_b = 1U;
  FlyByWire_DWork.Delay_DSTATE_fb = FlyByWire_P.RateLimiterVariableTs_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_k = FlyByWire_P.Delay_InitialCondition_m;
  FlyByWire_DWork.Delay1_DSTATE_b = FlyByWire_P.Delay1_InitialCondition_e;
  FlyByWire_DWork.Delay_DSTATE_h = FlyByWire_P.RateLimiterVariableTs2_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_b = FlyByWire_P.RateLimiterVariableTs1_InitialCondition_c;
  FlyByWire_DWork.icLoad_m = 1U;
  FlyByWire_DWork.Delay_DSTATE_bo = FlyByWire_P.RateLimiterVariableTs_InitialCondition_fc;
  FlyByWire_DWork.Delay_DSTATE_l = FlyByWire_P.Delay_InitialCondition_k;
  FlyByWire_DWork.Delay1_DSTATE_k = FlyByWire_P.Delay1_InitialCondition_o;
  FlyByWire_DWork.Delay_DSTATE_j5 = FlyByWire_P.Delay_InitialCondition_h;
  FlyByWire_DWork.Delay1_DSTATE_j = FlyByWire_P.Delay1_InitialCondition_l;
  ...
  FlyByWire_DWork.Delay1_DSTATE_c = FlyByWire_P.Delay1_InitialCondition_oe;
  ...
  FlyByWire_DWork.Delay_DSTATE_cw = FlyByWire_P.RateLimiterxi_InitialCondition;
