...
void FlyByWireModelClass::step()
{
  ...
  FlyByWire_DWork.Delay1_DSTATE = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_o - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE + (rtb_GainTheta + FlyByWire_DWork.Delay_DSTATE_c) * (rtb_Limiterxi / rtb_Limiterxi1);
  ...
  rtb_Product4 = FlyByWire_B.flare_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_l;
  ...
  FlyByWire_DWork.Delay_DSTATE_l += rtb_Product4;
  ...
  rtb_Product4 = FlyByWire_U.in.data.autopilot_custom_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_k3;
  ...
  FlyByWire_DWork.Delay_DSTATE_k3 += rtb_Product4;
  rtb_Product4 = Theta - FlyByWire_DWork.Delay_DSTATE_n;
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch1_Threshold) {
    rtb_Limiterxi1 = (FlyByWire_DWork.Delay_DSTATE_k3 - rtb_GainTheta) * FlyByWire_P.Gain4_Gain;
  } else {
    rtb_Gain1_b = FlyByWire_P.Gain1_Gain * rtb_GainTheta;
    if (rtb_in_flare > FlyByWire_P.Switch_Threshold) {
      rtb_Switch_c = (FlyByWire_DWork.Delay_DSTATE_l - rtb_GainTheta) * FlyByWire_P.Gain_Gain;
    ...
    if (FlyByWire_DWork.Delay_DSTATE_n <= rtb_Saturation2) {
      ...
      if (FlyByWire_DWork.Delay_DSTATE_n >= rtb_Saturation2) {
        rtb_Saturation2 = FlyByWire_DWork.Delay_DSTATE_n;
      }
    }
  ...
  rtb_Limiterxi = (rtb_Gain1_b - FlyByWire_DWork.Delay_DSTATE_g) / FlyByWire_U.in.time.dt + rtb_Limiterxi *
  ...
  } else if (FlyByWire_DWork.Delay_DSTATE_k < FlyByWire_P.Saturation_LowerSat_ex) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_ex;
  } else {
  ...
  rtb_Product4 = FlyByWire_DWork.Delay_DSTATE_m - FlyByWire_DWork.Delay_DSTATE_e;
  ...
  FlyByWire_DWork.Delay_DSTATE_e += rtb_Product4;
  ...
  rtb_Product4 = rtb_Limitereta - FlyByWire_DWork.Delay_DSTATE_p;
  ...
  FlyByWire_DWork.Delay_DSTATE_p += rtb_Product4;
  ...
  rtb_Limiterxi1 = rtb_Limiterxi + FlyByWire_P.Constant_Value_ma;
  FlyByWire_DWork.Delay1_DSTATE_a = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_ma - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_a + (rtb_Sum_dp + FlyByWire_DWork.Delay_DSTATE_h) * (rtb_Limiterxi / rtb_Limiterxi1);
  rtb_Product_p = FlyByWire_DWork.Delay1_DSTATE_a * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
  ...
  if (rtb_Product4 > FlyByWire_P.Saturation_UpperSat_n) {
    rtb_Product4 = FlyByWire_P.Saturation_UpperSat_n;
  } else {
  ...
  rtb_Limitereta = rtb_Product4 * FlyByWire_DWork.Delay_DSTATE_p;
  rtb_Product4 = FlyByWire_U.in.data.autopilot_custom_Phi_c_deg - FlyByWire_DWork.Delay_DSTATE_d;
  ...
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch_Threshold_p) {
    rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_d;
  } else {
    rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_ho;
  }

  rtb_Product4 = rtb_Limiterxi1 - FlyByWire_DWork.Delay_DSTATE_fg;
  ...
  FlyByWire_DWork.Delay_DSTATE_fg += rtb_Product4;
  rtb_Product4 = rtb_Saturation2 - FlyByWire_DWork.Delay_DSTATE_dm;
  ...
  FlyByWire_DWork.Delay_DSTATE_dm += rtb_Product4;
  ...
  FlyByWire_DWork.Delay1_DSTATE_b = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_k - rtb_Limiterxi1) *
    FlyByWire_DWork.Delay1_DSTATE_b + (rtb_Gain + FlyByWire_DWork.Delay_DSTATE_p1) * (rtb_Limiterxi1 / rtb_Limiterxi);
  ...
  rtb_Product3 = FlyByWire_P.Constant_Value_f / rtb_Limiterxi1;
  rtb_Product4 = FlyByWire_DWork.Delay_DSTATE_ke * rtb_Product3;
  rtb_Product3 *= rtb_Gain;
  FlyByWire_DWork.Delay1_DSTATE_f = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_f - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_f + (rtb_Product3 - rtb_Product4);
  FlyByWire_Y.out.roll.law_normal.pk_c_deg_s = rtb_Limitereta;
  rtb_BusAssignment_e_roll_law_normal_xi_deg = ((FlyByWire_P.Gain3_Gain_k * FlyByWire_DWork.Delay_DSTATE_dm +
    FlyByWire_DWork.Delay_DSTATE_fg) - rtb_GainPhi) * FlyByWire_P.Gain2_Gain_i + FlyByWire_P.Gain1_Gain_mg * result[0] *
    FlyByWire_P.pKp_Gain;
  rtb_Limiterxi1 = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_c;
  rtb_Limiterxi = rtb_Limiterxi1 + FlyByWire_P.Constant_Value_e;
  FlyByWire_DWork.Delay1_DSTATE_j = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_e - rtb_Limiterxi1) *
    FlyByWire_DWork.Delay1_DSTATE_j + (FlyByWire_U.in.data.beta_deg + FlyByWire_DWork.Delay_DSTATE_i) * (rtb_Limiterxi1 /
    rtb_Limiterxi);
  rtb_Product3 = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg + rtb_Product_p;
  rtb_Limitereta = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter1_C1;
  rtb_Limiterxi1 = rtb_Limitereta + FlyByWire_P.Constant_Value_i;
  FlyByWire_DWork.Delay1_DSTATE_n = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_i - rtb_Limitereta) *
    FlyByWire_DWork.Delay1_DSTATE_n + (rtb_Product3 + FlyByWire_DWork.Delay_DSTATE_oo) * (rtb_Limitereta /
    rtb_Limiterxi1);
  ...
  if (rtb_AND) {
    ...
    rtb_Limitereta = FlyByWire_DWork.Delay1_DSTATE_j;
  }
  ...
  rtb_Product4 = (rtb_Limiterxi + FlyByWire_DWork.Delay_DSTATE_gt) - FlyByWire_DWork.Delay_DSTATE_o;
  ...
  rtb_Product4 = (FlyByWire_DWork.Delay1_DSTATE_b - std::sin(FlyByWire_P.Gain1_Gain_br * FlyByWire_DWork.Delay_DSTATE_fg)
  ...
  rtb_Limitereta = FlyByWire_P.Gain6_Gain_k * FlyByWire_DWork.Delay1_DSTATE_f;
  ...
  if (rtb_on_ground > FlyByWire_P.Switch_Threshold_a) {
    rtb_Limiterxi = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg;
  } else {
    rtb_Limiterxi = FlyByWire_DWork.Delay_DSTATE_o;
  }

  rtb_Limitereta = ((FlyByWire_DWork.Delay_DSTATE_dm + rtb_Product4) * FlyByWire_DWork.Delay_DSTATE_p + rtb_Limitereta)
    + rtb_Limiterxi;
  ...
  rtb_Product4 = FlyByWire_DWork.Delay_DSTATE_fz - FlyByWire_DWork.Delay_DSTATE_p1o;
  ...
  FlyByWire_DWork.Delay_DSTATE_p1o += rtb_Product4;
  ...
  if (rtb_Limitereta > FlyByWire_P.Saturation_UpperSat_lh) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_lh;
  } else {
    if (rtb_Limitereta < FlyByWire_P.Saturation_LowerSat_le) {
      rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_le;
    }
  }

  rtb_Limiterxi1 = rtb_BusAssignment_e_roll_law_normal_xi_deg * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_jw - rtb_Limitereta;
  ...
  if (rtb_Limiterxi > FlyByWire_P.Saturation_UpperSat_g) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_g;
  } else if (rtb_Limiterxi < FlyByWire_P.Saturation_LowerSat_k) {
  ...
  rtb_Limitereta = FlyByWire_P.Constant_Value_ke - rtb_Limitereta;
  rtb_Limitereta *= rtb_Saturation2;
  rtb_Limiterxi += rtb_Limitereta;
  rtb_Product4 = rtb_Switch_c - FlyByWire_DWork.Delay_DSTATE_i5;
  ...
  FlyByWire_DWork.Delay_DSTATE_i5 += rtb_Product4;
  rtb_Product4 = rtb_Limiterxi1 - FlyByWire_DWork.Delay_DSTATE_cq;
  ...
  FlyByWire_DWork.Delay_DSTATE_cq += rtb_Product4;
  rtb_Product4 = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_a;
  ...
  FlyByWire_Y.out.pitch.data_computed.flare_Theta_c_deg = FlyByWire_DWork.Delay_DSTATE_l;
  ...
  FlyByWire_Y.out.roll.data_computed.beta_target_deg = rtb_Product_p;
  FlyByWire_Y.out.roll.law_normal.Phi_c_deg = FlyByWire_DWork.Delay_DSTATE_fg;
  ...
  FlyByWire_Y.out.roll.output.zeta_trim_deg = FlyByWire_DWork.Delay_DSTATE_p1o;
  rtb_Product4 = FlyByWire_P.Gaineta_Gain_d * FlyByWire_DWork.Delay_DSTATE_i5;
  ...
  rtb_Product4 = FlyByWire_P.GainiH_Gain * FlyByWire_DWork.Delay_DSTATE_e;
  ...
  rtb_Product4 = FlyByWire_P.Gainxi_Gain_n * FlyByWire_DWork.Delay_DSTATE_cq;
  ...
  rtb_Product4 = FlyByWire_P.Gainxi1_Gain_e * FlyByWire_DWork.Delay_DSTATE_a;
  ...
  rtb_Product4 = FlyByWire_P.Gainxi2_Gain * FlyByWire_DWork.Delay_DSTATE_p1o;
  ...
  FlyByWire_DWork.Delay_DSTATE_c = rtb_GainTheta;
  FlyByWire_DWork.Delay_DSTATE_g = rtb_Gain1_b;
  FlyByWire_DWork.icLoad = 0U;
  FlyByWire_DWork.icLoad_b = 0U;
  FlyByWire_DWork.Delay_DSTATE_h = rtb_Sum_dp;
  FlyByWire_DWork.icLoad_m = 0U;
  FlyByWire_DWork.Delay_DSTATE_p1 = rtb_Gain;
  FlyByWire_DWork.Delay_DSTATE_ke = rtb_Gain;
  FlyByWire_DWork.Delay_DSTATE_i = FlyByWire_U.in.data.beta_deg;
  FlyByWire_DWork.Delay_DSTATE_oo = rtb_Product3;
...
void FlyByWireModelClass::initialize()
{
  ...
  FlyByWire_DWork.Delay_DSTATE_c = FlyByWire_P.Delay_InitialCondition_c;
  ...
  FlyByWire_DWork.Delay_DSTATE_l = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_k3 = FlyByWire_P.RateLimiterVariableTs1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_n = FlyByWire_P.RateLimiterVariableTs_InitialCondition_c;
  FlyByWire_DWork.Delay_DSTATE_g = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition;
  FlyByWire_DWork.icLoad = 1U;
  ...
  FlyByWire_DWork.Delay_DSTATE_h = FlyByWire_P.Delay_InitialCondition_d;
  FlyByWire_DWork.Delay1_DSTATE_a = FlyByWire_P.Delay1_InitialCondition_k;
  FlyByWire_DWork.Delay_DSTATE_fg = FlyByWire_P.RateLimiterVariableTs2_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_d = FlyByWire_P.RateLimiterVariableTs1_InitialCondition_c;
  FlyByWire_DWork.icLoad_m = 1U;
  FlyByWire_DWork.Delay_DSTATE_dm = FlyByWire_P.RateLimiterVariableTs_InitialCondition_fc;
  FlyByWire_DWork.Delay_DSTATE_p1 = FlyByWire_P.Delay_InitialCondition_l;
  FlyByWire_DWork.Delay1_DSTATE_b = FlyByWire_P.Delay1_InitialCondition_a;
  FlyByWire_DWork.Delay_DSTATE_ke = FlyByWire_P.Delay_InitialCondition_e;
  FlyByWire_DWork.Delay1_DSTATE_f = FlyByWire_P.Delay1_InitialCondition_b;
  FlyByWire_DWork.Delay_DSTATE_o = FlyByWire_P.RateLimiterVariableTs1_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_i = FlyByWire_P.Delay_InitialCondition_g;
  FlyByWire_DWork.Delay1_DSTATE_j = FlyByWire_P.Delay1_InitialCondition_b2;
  FlyByWire_DWork.Delay_DSTATE_oo = FlyByWire_P.Delay_InitialCondition_f;
  FlyByWire_DWork.Delay1_DSTATE_n = FlyByWire_P.Delay1_InitialCondition_h;
  FlyByWire_DWork.icLoad_i = 1U;
  FlyByWire_DWork.Delay_DSTATE_p1o = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i4;
  FlyByWire_DWork.icLoad_c = 1U;
  FlyByWire_DWork.Delay_DSTATE_i5 = FlyByWire_P.RateLimitereta_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_cq = FlyByWire_P.RateLimiterxi_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_a = FlyByWire_P.RateLimiterzeta_InitialCondition;
