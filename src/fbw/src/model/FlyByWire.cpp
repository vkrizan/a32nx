...
void FlyByWireModelClass::step()
{
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gain1_Gain_h * FlyByWire_U.in.data.gear_animation_pos_1 - FlyByWire_P.Constant_Value_g;
  if (rtb_Limiterxi1 > FlyByWire_P.Saturation1_UpperSat_g) {
    rtb_Limiterxi1 = FlyByWire_P.Saturation1_UpperSat_g;
  } else {
    if (rtb_Limiterxi1 < FlyByWire_P.Saturation1_LowerSat_j) {
      rtb_Limiterxi1 = FlyByWire_P.Saturation1_LowerSat_j;
    }
  }
  ...
  FlyByWire_Y.out.sim.data.gear_strut_compression_1 = rtb_Limiterxi1;
  ...
  if (FlyByWire_DWork.is_active_c1_FlyByWire == 0U) {
    ...
    if ((rtb_Limiterxi1 > 0.1) || (rtb_Limitereta > 0.1)) {
      FlyByWire_DWork.is_c1_FlyByWire = FlyByWire_IN_OnGround;
      rtb_on_ground = 1;
    } else {
      rtb_on_ground = 0;
    ...
    if ((rtb_Limiterxi1 == 0.0) && (rtb_Limitereta == 0.0)) {
  ...
  rtb_NOT1 = ((FlyByWire_U.in.data.autopilot_master_on != 0.0) || (FlyByWire_U.in.data.slew_on != 0.0) ||
  ...
  FlyByWire_DWork.Delay1_DSTATE = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_f - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE + (rtb_GainTheta + FlyByWire_DWork.Delay_DSTATE_p) * (rtb_Limiterxi / rtb_Limiterxi1);
  ...
  rtb_Product4 = rtb_Limiterxi1 - FlyByWire_DWork.Delay_DSTATE_h;
  u1 = FlyByWire_P.RateLimiterVariableTs_up * FlyByWire_U.in.time.dt;
  if (rtb_Product4 < u1) {
    u1 = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimiterVariableTs_lo;
  if (u1 > rtb_Product4) {
    rtb_Product4 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_h += rtb_Product4;
  ...
  rtb_Product4 = FlyByWire_B.flare_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_d;
  u1 = std::abs(FlyByWire_B.flare_Theta_c_rate_deg_s) * FlyByWire_U.in.time.dt;
  if (rtb_Product4 < u1) {
    u1 = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_U.in.time.dt * FlyByWire_B.flare_Theta_c_rate_deg_s;
  if (u1 > rtb_Product4) {
    rtb_Product4 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_d += rtb_Product4;
  ...
  rtb_Product4 = FlyByWire_U.in.data.autopilot_custom_Theta_c_deg - FlyByWire_DWork.Delay_DSTATE_ha;
  u1 = FlyByWire_P.RateLimiterVariableTs1_up * FlyByWire_U.in.time.dt;
  if (rtb_Product4 < u1) {
    u1 = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimiterVariableTs1_lo;
  if (u1 > rtb_Product4) {
    rtb_Product4 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_ha += rtb_Product4;
  rtb_Product4 = Theta - FlyByWire_DWork.Delay_DSTATE_o;
  u1 = FlyByWire_P.RateLimiterVariableTs_up_f * FlyByWire_U.in.time.dt;
  if (rtb_Product4 < u1) {
    u1 = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimiterVariableTs_lo_f;
  if (u1 > rtb_Product4) {
    rtb_Product4 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_o += rtb_Product4;
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch1_Threshold) {
    rtb_Limiterxi1 = (FlyByWire_DWork.Delay_DSTATE_ha - rtb_GainTheta) * FlyByWire_P.Gain4_Gain;
  } else {
    ...
    if (FlyByWire_DWork.Delay_DSTATE_o <= rtb_Saturation2) {
  ...
  rtb_Limiterxi1 += std::cos(FlyByWire_P.Gain1_Gain_p * rtb_GainTheta) / std::cos(FlyByWire_P.Gain1_Gain_b * rtb_Gain1_b);
  if (rtb_Limiterxi1 > rtb_nz_limit_up_g) {
    rtb_Limiterxi1 = rtb_nz_limit_up_g;
  } else {
    if (rtb_Limiterxi1 < rtb_nz_limit_lo_g) {
      rtb_Limiterxi1 = rtb_nz_limit_lo_g;
    }
  }

  rtb_Limiterxi = rtb_Limitereta - rtb_Limiterxi1;
  ...
  rtb_Limiterxi = (rtb_Gain1_b - FlyByWire_DWork.Delay_DSTATE_ok) / FlyByWire_U.in.time.dt + rtb_Limiterxi *
  ...
  FlyByWire_Y.out.pitch.law_normal.nz_c_g = rtb_Limiterxi1;
  ...
  if (FlyByWire_DWork.Delay_DSTATE_h > FlyByWire_P.Saturation_UpperSat_n) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_n;
  } else if (FlyByWire_DWork.Delay_DSTATE_h < FlyByWire_P.Saturation_LowerSat_a2) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_a2;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_h;
  }

  rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_f * rtb_Limitereta;
  ...
  rtb_Switch_c = rtb_Limiterxi1 + rtb_Limitereta;
  ...
  rtb_Limiterxi1 = FlyByWire_P.Gain_Gain_ip * rtb_Limitereta * FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_g *
  ...
  if (FlyByWire_DWork.icLoad_b != 0) {
    FlyByWire_DWork.Delay_DSTATE_m = rtb_eta_trim_deg_reset_deg - rtb_Limiterxi1;
  }

  rtb_Limiterxi1 += FlyByWire_DWork.Delay_DSTATE_m;
  if (rtb_Limiterxi1 > FlyByWire_P.DiscreteTimeIntegratorVariableTs_UpperLimit_j) {
    FlyByWire_DWork.Delay_DSTATE_m = FlyByWire_P.DiscreteTimeIntegratorVariableTs_UpperLimit_j;
  } else if (rtb_Limiterxi1 < FlyByWire_P.DiscreteTimeIntegratorVariableTs_LowerLimit_g) {
  ...
  rtb_Product4 = FlyByWire_DWork.Delay_DSTATE_m - FlyByWire_DWork.Delay_DSTATE_fi;
  u1 = rtb_ManualSwitch * FlyByWire_U.in.time.dt;
  if (rtb_Product4 < u1) {
    u1 = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_U.in.time.dt * rtb_eta_trim_deg_rate_limit_lo_deg_s;
  if (u1 > rtb_Product4) {
    rtb_Product4 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_fi += rtb_Product4;
  ...
  rtb_Product4 = rtb_Limitereta - FlyByWire_DWork.Delay_DSTATE_dj;
  u1 = FlyByWire_P.RateLimiterVariableTs_up_k * FlyByWire_U.in.time.dt;
  if (rtb_Product4 < u1) {
    u1 = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimiterVariableTs_lo_fs;
  if (u1 > rtb_Product4) {
    rtb_Product4 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_dj += rtb_Product4;
  ...
  FlyByWire_DWork.Delay1_DSTATE_e = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_d - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_e + (rtb_Sum_k + FlyByWire_DWork.Delay_DSTATE_d5) * (rtb_Limiterxi / rtb_Limiterxi1);
  rtb_Product_j = FlyByWire_DWork.Delay1_DSTATE_e * look1_binlxpw(FlyByWire_U.in.data.V_tas_kn,
  ...
  rtb_Product4 = FlyByWire_P.Gain1_Gain_m * Phi + look1_binlxpw(rtb_GainPhi, FlyByWire_P.BankAngleProtection_bp01Data,
    FlyByWire_P.BankAngleProtection_tableData, 6U);
  if (rtb_Product4 > FlyByWire_P.Saturation_UpperSat_nq) {
    rtb_Product4 = FlyByWire_P.Saturation_UpperSat_nq;
  } else {
    if (rtb_Product4 < FlyByWire_P.Saturation_LowerSat_o) {
      rtb_Product4 = FlyByWire_P.Saturation_LowerSat_o;
    }
  }

  rtb_Limitereta = rtb_Product4 * FlyByWire_DWork.Delay_DSTATE_dj;
  rtb_Product4 = FlyByWire_U.in.data.autopilot_custom_Phi_c_deg - FlyByWire_DWork.Delay_DSTATE_pj;
  u1 = FlyByWire_P.RateLimiterVariableTs1_up_k * FlyByWire_U.in.time.dt;
  if (rtb_Product4 < u1) {
    u1 = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimiterVariableTs1_lo_j;
  if (u1 > rtb_Product4) {
    rtb_Product4 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_pj += rtb_Product4;
  rtb_Limiterxi1 = FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_d * rtb_Limitereta * FlyByWire_U.in.time.dt;
  if ((FlyByWire_DWork.Delay_DSTATE_dj == 0.0) || (rtb_BusAssignment_a_sim_data_computed_tracking_mode_on != 0) ||
      (FlyByWire_U.in.data.autopilot_custom_on != 0.0)) {
    FlyByWire_DWork.icLoad_m = 1U;
  }

  if (FlyByWire_DWork.icLoad_m != 0) {
    FlyByWire_DWork.Delay_DSTATE_ho = rtb_GainPhi - rtb_Limiterxi1;
  }

  rtb_Limiterxi1 += FlyByWire_DWork.Delay_DSTATE_ho;
  if (rtb_Limiterxi1 > FlyByWire_P.DiscreteTimeIntegratorVariableTs_UpperLimit_d) {
    FlyByWire_DWork.Delay_DSTATE_ho = FlyByWire_P.DiscreteTimeIntegratorVariableTs_UpperLimit_d;
  } else if (rtb_Limiterxi1 < FlyByWire_P.DiscreteTimeIntegratorVariableTs_LowerLimit_k) {
    FlyByWire_DWork.Delay_DSTATE_ho = FlyByWire_P.DiscreteTimeIntegratorVariableTs_LowerLimit_k;
  } else {
    FlyByWire_DWork.Delay_DSTATE_ho = rtb_Limiterxi1;
  }

  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch_Threshold_p) {
    rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_pj;
  } else {
    rtb_Limiterxi1 = FlyByWire_DWork.Delay_DSTATE_ho;
  }

  rtb_Product4 = rtb_Limiterxi1 - FlyByWire_DWork.Delay_DSTATE_oz;
  u1 = FlyByWire_P.RateLimiterVariableTs2_up * FlyByWire_U.in.time.dt;
  if (rtb_Product4 < u1) {
    u1 = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimiterVariableTs2_lo;
  if (u1 > rtb_Product4) {
    rtb_Product4 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_oz += rtb_Product4;
  rtb_Product4 = rtb_Saturation2 - FlyByWire_DWork.Delay_DSTATE_a;
  u1 = FlyByWire_P.RateLimiterVariableTs_up_m * FlyByWire_U.in.time.dt;
  if (rtb_Product4 < u1) {
    u1 = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimiterVariableTs_lo_p;
  if (u1 > rtb_Product4) {
    rtb_Product4 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_a += rtb_Product4;
  rtb_Limiterxi1 = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_d;
  rtb_Limiterxi = rtb_Limiterxi1 + FlyByWire_P.Constant_Value_k;
  FlyByWire_DWork.Delay1_DSTATE_j = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_k - rtb_Limiterxi1) *
    FlyByWire_DWork.Delay1_DSTATE_j + (rtb_Gain + FlyByWire_DWork.Delay_DSTATE_j) * (rtb_Limiterxi1 / rtb_Limiterxi);
  ...
  rtb_Product3 = FlyByWire_P.Constant_Value_c / rtb_Limiterxi1;
  rtb_Product4 = FlyByWire_DWork.Delay_DSTATE_jt * rtb_Product3;
  rtb_Product3 *= rtb_Gain;
  FlyByWire_DWork.Delay1_DSTATE_o = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_c - rtb_Limiterxi) *
    FlyByWire_DWork.Delay1_DSTATE_o + (rtb_Product3 - rtb_Product4);
  FlyByWire_Y.out.roll.law_normal.pk_c_deg_s = rtb_Limitereta;
  rtb_BusAssignment_e_roll_law_normal_xi_deg = ((FlyByWire_P.Gain3_Gain_k * FlyByWire_DWork.Delay_DSTATE_a +
    FlyByWire_DWork.Delay_DSTATE_oz) - rtb_GainPhi) * FlyByWire_P.Gain2_Gain_i + FlyByWire_P.Gain1_Gain_mg * result[0] *
    FlyByWire_P.pKp_Gain;
  rtb_Limiterxi1 = FlyByWire_U.in.time.dt * FlyByWire_P.LagFilter_C1_c;
  rtb_Limiterxi = rtb_Limiterxi1 + FlyByWire_P.Constant_Value_fz;
  FlyByWire_DWork.Delay1_DSTATE_d = 1.0 / rtb_Limiterxi * (FlyByWire_P.Constant_Value_fz - rtb_Limiterxi1) *
    FlyByWire_DWork.Delay1_DSTATE_d + (FlyByWire_U.in.data.beta_deg + FlyByWire_DWork.Delay_DSTATE_pk) * (rtb_Limiterxi1
    / rtb_Limiterxi);
  ...
  rtb_Limiterxi1 = rtb_Limitereta + FlyByWire_P.Constant_Value_n;
  FlyByWire_DWork.Delay1_DSTATE_k = 1.0 / rtb_Limiterxi1 * (FlyByWire_P.Constant_Value_n - rtb_Limitereta) *
    FlyByWire_DWork.Delay1_DSTATE_k + (rtb_Product3 + FlyByWire_DWork.Delay_DSTATE_fv) * (rtb_Limitereta /
    rtb_Limiterxi1);
  rtb_AND = ((rtb_BusAssignment_a_sim_data_computed_tracking_mode_on == 0) && (FlyByWire_U.in.data.autopilot_custom_on
              != 0.0));
  if (rtb_AND) {
    rtb_Limitereta = FlyByWire_DWork.Delay1_DSTATE_k;
  } else {
  ...
  if (FlyByWire_DWork.icLoad_i != 0) {
    FlyByWire_DWork.Delay_DSTATE_g = FlyByWire_P.fbw_output_MATLABStruct.roll.output.zeta_deg - rtb_Limitereta;
  }

  rtb_Limitereta += FlyByWire_DWork.Delay_DSTATE_g;
  if (rtb_Limitereta > FlyByWire_P.DiscreteTimeIntegratorVariableTs1_UpperLimit) {
    FlyByWire_DWork.Delay_DSTATE_g = FlyByWire_P.DiscreteTimeIntegratorVariableTs1_UpperLimit;
  } else if (rtb_Limitereta < FlyByWire_P.DiscreteTimeIntegratorVariableTs1_LowerLimit) {
    FlyByWire_DWork.Delay_DSTATE_g = FlyByWire_P.DiscreteTimeIntegratorVariableTs1_LowerLimit;
  } else {
    FlyByWire_DWork.Delay_DSTATE_g = rtb_Limitereta;
  }

  rtb_Product4 = (rtb_Limiterxi + FlyByWire_DWork.Delay_DSTATE_g) - FlyByWire_DWork.Delay_DSTATE_n;
  u1 = FlyByWire_P.RateLimiterVariableTs1_up_p * FlyByWire_U.in.time.dt;
  if (rtb_Product4 < u1) {
    u1 = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimiterVariableTs1_lo_h;
  if (u1 > rtb_Product4) {
    rtb_Product4 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_n += rtb_Product4;
  ...
  rtb_Product4 = (FlyByWire_DWork.Delay1_DSTATE_j - std::sin(FlyByWire_P.Gain1_Gain_br * FlyByWire_DWork.Delay_DSTATE_oz)
  ...
  rtb_Limitereta = FlyByWire_P.Gain6_Gain_k * FlyByWire_DWork.Delay1_DSTATE_o;
  if (rtb_Product4 > FlyByWire_P.Saturation1_UpperSat_h) {
    rtb_Product4 = FlyByWire_P.Saturation1_UpperSat_h;
  } else {
    if (rtb_Product4 < FlyByWire_P.Saturation1_LowerSat_g) {
      rtb_Product4 = FlyByWire_P.Saturation1_LowerSat_g;
    }
  }

  if (rtb_Limitereta > FlyByWire_P.Saturation2_UpperSat_e) {
    rtb_Limitereta = FlyByWire_P.Saturation2_UpperSat_e;
  } else {
    if (rtb_Limitereta < FlyByWire_P.Saturation2_LowerSat_gp) {
      rtb_Limitereta = FlyByWire_P.Saturation2_LowerSat_gp;
    }
  }

  rtb_Limitereta = ((FlyByWire_DWork.Delay_DSTATE_a + rtb_Product4) * FlyByWire_DWork.Delay_DSTATE_dj + rtb_Limitereta)
    + FlyByWire_DWork.Delay_DSTATE_n;
  rtb_Limiterxi1 = FlyByWire_P.Gain4_Gain_h * rtb_Limitereta * FlyByWire_P.DiscreteTimeIntegratorVariableTs1_Gain_e *
    FlyByWire_U.in.time.dt;
  ...
  if (FlyByWire_DWork.icLoad_c != 0) {
    FlyByWire_DWork.Delay_DSTATE_fz = result_tmp - rtb_Limiterxi1;
  }

  rtb_Limiterxi1 += FlyByWire_DWork.Delay_DSTATE_fz;
  if (rtb_Limiterxi1 > FlyByWire_P.DiscreteTimeIntegratorVariableTs1_UpperLimit_e) {
    FlyByWire_DWork.Delay_DSTATE_fz = FlyByWire_P.DiscreteTimeIntegratorVariableTs1_UpperLimit_e;
  } else if (rtb_Limiterxi1 < FlyByWire_P.DiscreteTimeIntegratorVariableTs1_LowerLimit_o) {
  ...
  rtb_Product4 = FlyByWire_DWork.Delay_DSTATE_fz - FlyByWire_DWork.Delay_DSTATE_p5;
  u1 = FlyByWire_P.Constant_Value_b * FlyByWire_U.in.time.dt;
  if (rtb_Product4 < u1) {
    u1 = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_U.in.time.dt * FlyByWire_P.Constant1_Value_a;
  if (u1 > rtb_Product4) {
    rtb_Product4 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_p5 += rtb_Product4;
  rtb_BusAssignment_f_roll_law_normal_zeta_deg = rtb_Limitereta;
  if (FlyByWire_DWork.Delay_DSTATE_dj > FlyByWire_P.Saturation_UpperSat_f) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_f;
  } else if (FlyByWire_DWork.Delay_DSTATE_dj < FlyByWire_P.Saturation_LowerSat_k) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_k;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_dj;
  }

  rtb_Limiterxi1 = rtb_BusAssignment_e_roll_law_normal_xi_deg * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_a - rtb_Limitereta;
  rtb_Limitereta *= rtb_BusAssignment_p_roll_data_computed_delta_xi_deg;
  rtb_Limiterxi1 += rtb_Limitereta;
  if (FlyByWire_DWork.Delay_DSTATE_dj > FlyByWire_P.Saturation_UpperSat_m) {
    rtb_Limitereta = FlyByWire_P.Saturation_UpperSat_m;
  } else if (FlyByWire_DWork.Delay_DSTATE_dj < FlyByWire_P.Saturation_LowerSat_lw) {
    rtb_Limitereta = FlyByWire_P.Saturation_LowerSat_lw;
  } else {
    rtb_Limitereta = FlyByWire_DWork.Delay_DSTATE_dj;
  }

  rtb_Limiterxi = rtb_BusAssignment_f_roll_law_normal_zeta_deg * rtb_Limitereta;
  rtb_Limitereta = FlyByWire_P.Constant_Value_h - rtb_Limitereta;
  rtb_Limitereta *= rtb_Saturation2;
  rtb_Limiterxi += rtb_Limitereta;
  rtb_Product4 = rtb_Switch_c - FlyByWire_DWork.Delay_DSTATE_jtw;
  u1 = FlyByWire_P.RateLimitereta_up * FlyByWire_U.in.time.dt;
  if (rtb_Product4 < u1) {
    u1 = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimitereta_lo;
  if (u1 > rtb_Product4) {
    rtb_Product4 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_jtw += rtb_Product4;
  rtb_Product4 = rtb_Limiterxi1 - FlyByWire_DWork.Delay_DSTATE_k;
  u1 = FlyByWire_P.RateLimiterxi_up * FlyByWire_U.in.time.dt;
  if (rtb_Product4 < u1) {
    u1 = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimiterxi_lo;
  if (u1 > rtb_Product4) {
    rtb_Product4 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_k += rtb_Product4;
  rtb_Product4 = rtb_Limiterxi - FlyByWire_DWork.Delay_DSTATE_nr;
  u1 = FlyByWire_P.RateLimiterzeta_up * FlyByWire_U.in.time.dt;
  if (rtb_Product4 < u1) {
    u1 = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_U.in.time.dt * FlyByWire_P.RateLimiterzeta_lo;
  if (u1 > rtb_Product4) {
    rtb_Product4 = u1;
  }

  FlyByWire_DWork.Delay_DSTATE_nr += rtb_Product4;
  ...
  rtb_Product4 = FlyByWire_P.Gain_Gain_i * FlyByWire_U.in.data.gear_animation_pos_0 - FlyByWire_P.Constant_Value_g;
  if (rtb_Product4 > FlyByWire_P.Saturation_UpperSat_e) {
    FlyByWire_Y.out.sim.data.gear_strut_compression_0 = FlyByWire_P.Saturation_UpperSat_e;
  } else if (rtb_Product4 < FlyByWire_P.Saturation_LowerSat_e) {
    FlyByWire_Y.out.sim.data.gear_strut_compression_0 = FlyByWire_P.Saturation_LowerSat_e;
  } else {
    FlyByWire_Y.out.sim.data.gear_strut_compression_0 = rtb_Product4;
  }
  ...
  FlyByWire_Y.out.pitch.data_computed.in_flight_gain = FlyByWire_DWork.Delay_DSTATE_h;
  ...
  FlyByWire_Y.out.pitch.data_computed.eta_trim_deg_reset = rtb_NOT1;
  ...
  FlyByWire_Y.out.pitch.output.eta_trim_deg = FlyByWire_DWork.Delay_DSTATE_fi;
  ...
  FlyByWire_Y.out.roll.data_computed.in_flight_gain = FlyByWire_DWork.Delay_DSTATE_dj;
  ...
  FlyByWire_Y.out.roll.law_normal.Phi_c_deg = FlyByWire_DWork.Delay_DSTATE_oz;
  ...
  FlyByWire_Y.out.roll.output.xi_deg = rtb_Limiterxi1;
  FlyByWire_Y.out.roll.output.zeta_deg = rtb_Limiterxi;
  FlyByWire_Y.out.roll.output.zeta_trim_deg = FlyByWire_DWork.Delay_DSTATE_p5;
  rtb_Product4 = FlyByWire_P.Gaineta_Gain_d * FlyByWire_DWork.Delay_DSTATE_jtw;
  if (rtb_Product4 > FlyByWire_P.Limitereta_UpperSat) {
    FlyByWire_Y.out.output.eta_pos = FlyByWire_P.Limitereta_UpperSat;
  } else if (rtb_Product4 < FlyByWire_P.Limitereta_LowerSat) {
    FlyByWire_Y.out.output.eta_pos = FlyByWire_P.Limitereta_LowerSat;
  } else {
    FlyByWire_Y.out.output.eta_pos = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_P.GainiH_Gain * FlyByWire_DWork.Delay_DSTATE_fi;
  if (rtb_Product4 > FlyByWire_P.LimiteriH_UpperSat) {
    FlyByWire_Y.out.output.eta_trim_deg = FlyByWire_P.LimiteriH_UpperSat;
  } else if (rtb_Product4 < FlyByWire_P.LimiteriH_LowerSat) {
    FlyByWire_Y.out.output.eta_trim_deg = FlyByWire_P.LimiteriH_LowerSat;
  } else {
    FlyByWire_Y.out.output.eta_trim_deg = rtb_Product4;
  }

  FlyByWire_Y.out.output.eta_trim_deg_should_write = rtb_eta_trim_deg_should_write;
  rtb_Product4 = FlyByWire_P.Gainxi_Gain_n * FlyByWire_DWork.Delay_DSTATE_k;
  if (rtb_Product4 > FlyByWire_P.Limiterxi_UpperSat) {
    FlyByWire_Y.out.output.xi_pos = FlyByWire_P.Limiterxi_UpperSat;
  } else if (rtb_Product4 < FlyByWire_P.Limiterxi_LowerSat) {
    FlyByWire_Y.out.output.xi_pos = FlyByWire_P.Limiterxi_LowerSat;
  } else {
    FlyByWire_Y.out.output.xi_pos = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_P.Gainxi1_Gain_e * FlyByWire_DWork.Delay_DSTATE_nr;
  if (rtb_Product4 > FlyByWire_P.Limiterxi1_UpperSat) {
    FlyByWire_Y.out.output.zeta_pos = FlyByWire_P.Limiterxi1_UpperSat;
  } else if (rtb_Product4 < FlyByWire_P.Limiterxi1_LowerSat) {
    FlyByWire_Y.out.output.zeta_pos = FlyByWire_P.Limiterxi1_LowerSat;
  } else {
    FlyByWire_Y.out.output.zeta_pos = rtb_Product4;
  }

  rtb_Product4 = FlyByWire_P.Gainxi2_Gain * FlyByWire_DWork.Delay_DSTATE_p5;
  if (rtb_Product4 > FlyByWire_P.Limiterxi2_UpperSat) {
    FlyByWire_Y.out.output.zeta_trim_pos = FlyByWire_P.Limiterxi2_UpperSat;
  } else if (rtb_Product4 < FlyByWire_P.Limiterxi2_LowerSat) {
    FlyByWire_Y.out.output.zeta_trim_pos = FlyByWire_P.Limiterxi2_LowerSat;
  } else {
    FlyByWire_Y.out.output.zeta_trim_pos = rtb_Product4;
  }

  FlyByWire_Y.out.output.zeta_trim_pos_should_write = (FlyByWire_U.in.data.autopilot_custom_on != 0.0);
  FlyByWire_DWork.Delay_DSTATE_p = rtb_GainTheta;
  FlyByWire_DWork.Delay_DSTATE_ok = rtb_Gain1_b;
  FlyByWire_DWork.icLoad = 0U;
  FlyByWire_DWork.icLoad_b = 0U;
  FlyByWire_DWork.Delay_DSTATE_d5 = rtb_Sum_k;
  FlyByWire_DWork.icLoad_m = 0U;
  FlyByWire_DWork.Delay_DSTATE_j = rtb_Gain;
  FlyByWire_DWork.Delay_DSTATE_jt = rtb_Gain;
  FlyByWire_DWork.Delay_DSTATE_pk = FlyByWire_U.in.data.beta_deg;
  FlyByWire_DWork.Delay_DSTATE_fv = rtb_Product3;
...
void FlyByWireModelClass::initialize()
{
  ...
  FlyByWire_DWork.Delay_DSTATE_p = FlyByWire_P.Delay_InitialCondition_n;
  FlyByWire_DWork.Delay1_DSTATE = FlyByWire_P.Delay1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_h = FlyByWire_P.RateLimiterVariableTs_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_d = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_ha = FlyByWire_P.RateLimiterVariableTs1_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_o = FlyByWire_P.RateLimiterVariableTs_InitialCondition_c;
  FlyByWire_DWork.Delay_DSTATE_ok = FlyByWire_P.DiscreteDerivativeVariableTs_InitialCondition;
  FlyByWire_DWork.icLoad = 1U;
  FlyByWire_DWork.Delay_DSTATE_fi = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i;
  FlyByWire_DWork.icLoad_b = 1U;
  FlyByWire_DWork.Delay_DSTATE_dj = FlyByWire_P.RateLimiterVariableTs_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_d5 = FlyByWire_P.Delay_InitialCondition_a;
  FlyByWire_DWork.Delay1_DSTATE_e = FlyByWire_P.Delay1_InitialCondition_a;
  FlyByWire_DWork.Delay_DSTATE_oz = FlyByWire_P.RateLimiterVariableTs2_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_pj = FlyByWire_P.RateLimiterVariableTs1_InitialCondition_c;
  FlyByWire_DWork.icLoad_m = 1U;
  FlyByWire_DWork.Delay_DSTATE_a = FlyByWire_P.RateLimiterVariableTs_InitialCondition_fc;
  FlyByWire_DWork.Delay_DSTATE_j = FlyByWire_P.Delay_InitialCondition_l;
  FlyByWire_DWork.Delay1_DSTATE_j = FlyByWire_P.Delay1_InitialCondition_e;
  FlyByWire_DWork.Delay_DSTATE_jt = FlyByWire_P.Delay_InitialCondition_h;
  FlyByWire_DWork.Delay1_DSTATE_o = FlyByWire_P.Delay1_InitialCondition_c;
  FlyByWire_DWork.Delay_DSTATE_n = FlyByWire_P.RateLimiterVariableTs1_InitialCondition_f;
  FlyByWire_DWork.Delay_DSTATE_pk = FlyByWire_P.Delay_InitialCondition_p;
  FlyByWire_DWork.Delay1_DSTATE_d = FlyByWire_P.Delay1_InitialCondition_g;
  FlyByWire_DWork.Delay_DSTATE_fv = FlyByWire_P.Delay_InitialCondition_e;
  FlyByWire_DWork.Delay1_DSTATE_k = FlyByWire_P.Delay1_InitialCondition_i;
  FlyByWire_DWork.icLoad_i = 1U;
  FlyByWire_DWork.Delay_DSTATE_p5 = FlyByWire_P.RateLimiterDynamicVariableTs_InitialCondition_i4;
  FlyByWire_DWork.icLoad_c = 1U;
  FlyByWire_DWork.Delay_DSTATE_jtw = FlyByWire_P.RateLimitereta_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_k = FlyByWire_P.RateLimiterxi_InitialCondition;
  FlyByWire_DWork.Delay_DSTATE_nr = FlyByWire_P.RateLimiterzeta_InitialCondition;
