...
typedef struct {
  ...
  real_T Delay_DSTATE_ob;
  real_T Delay_DSTATE_ed;
  real_T Delay1_DSTATE_lp;
  real_T Delay_DSTATE_ip;
  real_T Delay_DSTATE_f;
  real_T Delay1_DSTATE_b1;
  ...
  rtDW_Chart_Autopilot_T sf_Chart_nr;
  rtDW_Chart_Autopilot_T sf_Chart_n;
  rtDW_Chart_Autopilot_T sf_Chart_p;
  rtDW_Chart_Autopilot_T sf_Chart_gi;
...
struct Parameters_Autopilot_T_ {
  ...
  real_T ScheduledGain_BreakpointsForDimension1_j5[4];
  ...
  real_T ScheduledGain_Table_hb[4];
  ...
  real_T Constant3_Value_nu;
  real_T Gain_Gain_p;
  real_T Constant_Value_c;
  real_T Constant3_Value_gl;
  real_T Gain_Gain_ee;
  real_T Constant_Value_i;
  real_T Constant3_Value_ck;
  real_T Constant3_Value_cm;
  real_T Gain_Gain_nu;
  ...
  real_T Constant3_Value_be;
  real_T Gain3_Gain;
  real_T Gain_Gain_av;
  real_T Constant_Value_e;
  real_T Constant3_Value_oy;
  real_T Constant3_Value_hd;
  real_T Gain3_Gain_i;
  ...
  real_T IC_Value_m;
  real_T Gain3_Gain_f;
  real_T Delay_InitialCondition_my;
  real_T Constant_Value_lq;
  ...
  real_T Gain1_Gain_mn;
  real_T kntoms_Gain_f;
  real_T msftmin_Gain_ia;
