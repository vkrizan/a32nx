...
struct Parameters_Autopilot_T_ {
  ...
  real_T Delay1_InitialCondition_nw;
  ...
  real_T Gain_Gain_l0x;
  real_T Gain_Gain_d;
  real_T Constant1_Value_l;
  real_T Gain_Gain_hk;
  real_T Constant_Value_in;
  real_T Gain1_Gain_p3;
  real_T Gain1_Gain_lu;
