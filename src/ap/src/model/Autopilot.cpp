...
void AutopilotModelClass::step()
{
  ...
  rtb_Mod1_b = std::tan(rtb_Saturation1);
  rtb_Saturation = std::sin(rtb_out_p);
  rtb_out_p = std::cos(rtb_out_p);
  tmp[0] = 1.0;
  tmp[3] = rtb_Saturation * rtb_Mod1_b;
  tmp[6] = rtb_out_p * rtb_Mod1_b;
  tmp[1] = 0.0;
  tmp[4] = rtb_out_p;
  ...
  rtb_Mod1_b = Autopilot_P.Gain_Gain_aq * Autopilot_U.in.data.r_rad_s;
  for (rtb_on_ground = 0; rtb_on_ground < 3; rtb_on_ground++) {
    result[rtb_on_ground] = tmp[rtb_on_ground + 6] * rtb_Mod1_b + (tmp[rtb_on_ground + 3] * rtb_Saturation1 +
  ...
  Autopilot_Chart(rtb_Saturation, Autopilot_P.Gain_Gain_h * rt_modd(Autopilot_P.Constant3_Value_e - rtb_Saturation,
    Autopilot_P.Constant3_Value_e), Autopilot_P.Constant2_Value_l, &rtb_Saturation1, &Autopilot_DWork.sf_Chart_k);
  ...
  rtb_Mod1_b = rt_modd((rt_modd((std::sin(Autopilot_P.Gain1_Gain_ge * Autopilot_U.in.data.nav_radial_error_deg) *
    Autopilot_U.in.data.nav_dme_nmi * Autopilot_P.Gain2_Gain + (rtb_Saturation - Autopilot_U.in.data.Psi_magnetic_deg)) *
    Autopilot_P.Gain4_Gain_f + (Autopilot_U.in.data.Psi_magnetic_deg + Autopilot_P.Constant_Value_bl),
    Autopilot_P.Constant_Value_bl) - (Autopilot_U.in.data.Psi_magnetic_deg + Autopilot_P.Constant3_Value_h)) +
                       Autopilot_P.Constant3_Value_h, Autopilot_P.Constant3_Value_h);
  Autopilot_Chart(rtb_Mod1_b, Autopilot_P.Gain_Gain_n * rt_modd(Autopilot_P.Constant3_Value_h - rtb_Mod1_b,
    Autopilot_P.Constant3_Value_h), Autopilot_P.Constant1_Value_m, &rtb_out_p, &Autopilot_DWork.sf_Chart_f);
  switch (static_cast<int32_T>(rtb_ManualSwitch)) {
   case 1:
    rtb_Mod1_b = Autopilot_P.beta_Value_e;
    break;

   case 2:
    rtb_Mod1_b = Autopilot_P.beta_Value_b;
    break;

   case 3:
    rtb_Mod1_b = Autopilot_P.beta_Value_m;
    break;

   case 4:
    rtb_Mod1_b = Autopilot_P.beta_Value;
    break;

   case 5:
    if (Autopilot_U.in.data.H_radio_ft <= Autopilot_P.CompareToConstant_const) {
      rtb_Mod1_b = Autopilot_P.Gain_Gain_a * rtb_Saturation1;
    } else {
      rtb_Mod1_b = Autopilot_P.Constant1_Value;
    }
    break;

   default:
    rtb_Mod1_b = Autopilot_P.Gain5_Gain * rtb_out_p + Autopilot_P.Gain_Gain * result[2];
    break;
  }
  ...
  Autopilot_Chart(rtb_Saturation1, Autopilot_P.Gain_Gain_jz * rt_modd(Autopilot_P.Constant3_Value_m - rtb_Saturation1,
    Autopilot_P.Constant3_Value_m), Autopilot_P.Constant_Value_c, &rtb_out_k, &Autopilot_DWork.sf_Chart_j);
  ...
  Autopilot_Chart(rtb_Saturation1, Autopilot_P.Gain_Gain_i2 * rt_modd(Autopilot_P.Constant3_Value_l - rtb_Saturation1,
    Autopilot_P.Constant3_Value_l), Autopilot_P.Constant_Value_i, &rtb_out_c, &Autopilot_DWork.sf_Chart_a);
  rtb_out_p = Autopilot_P.Gain_Gain_nu * Autopilot_U.in.data.flight_guidance_xtk_nmi;
  ...
  rtb_Saturation1 = rt_modd((rt_modd((Autopilot_P.Gain2_Gain_f * Autopilot_U.in.data.flight_guidance_tae_deg + rtb_out_p)
    * Autopilot_P.Gain1_Gain_n + (Autopilot_U.in.data.Psi_magnetic_track_deg + Autopilot_P.Constant_Value_e),
    Autopilot_P.Constant_Value_e) - (Autopilot_U.in.data.Psi_magnetic_track_deg + Autopilot_P.Constant3_Value_nf)) +
    Autopilot_P.Constant3_Value_nf, Autopilot_P.Constant3_Value_nf);
  Autopilot_Chart(rtb_Saturation1, Autopilot_P.Gain_Gain_o * rt_modd(Autopilot_P.Constant3_Value_nf - rtb_Saturation1,
    Autopilot_P.Constant3_Value_nf), Autopilot_P.Constant_Value_cw, &rtb_out_a, &Autopilot_DWork.sf_Chart_d);
  ...
  rtb_Saturation = rt_modd((rt_modd(((rtb_Saturation - Autopilot_U.in.data.Psi_magnetic_track_deg) + rtb_out_p) *
    Autopilot_P.Gain3_Gain + (Autopilot_U.in.data.Psi_magnetic_track_deg + Autopilot_P.Constant_Value_pl),
    Autopilot_P.Constant_Value_pl) - (Autopilot_U.in.data.Psi_magnetic_track_deg + Autopilot_P.Constant3_Value_f)) +
    Autopilot_P.Constant3_Value_f, Autopilot_P.Constant3_Value_f);
  Autopilot_Chart(rtb_Saturation, Autopilot_P.Gain_Gain_b * rt_modd(Autopilot_P.Constant3_Value_f - rtb_Saturation,
    Autopilot_P.Constant3_Value_f), Autopilot_P.Constant_Value_e5, &rtb_out_p, &Autopilot_DWork.sf_Chart_b);
  ...
  rtb_Mod1_k = Autopilot_U.in.time.dt * Autopilot_P.LagFilter_C1;
  rtb_Minup = rtb_Mod1_k + Autopilot_P.Constant_Value_g;
  Autopilot_DWork.Delay1_DSTATE = 1.0 / rtb_Minup * (Autopilot_P.Constant_Value_g - rtb_Mod1_k) *
    Autopilot_DWork.Delay1_DSTATE + (rtb_Saturation1 + Autopilot_DWork.Delay_DSTATE_c) * (rtb_Mod1_k / rtb_Minup);
  rtb_Mod1_k = rt_modd((rt_modd(Autopilot_DWork.Delay1_DSTATE * look1_binlxpw(Autopilot_U.in.data.H_radio_ft,
    Autopilot_P.ScheduledGain_BreakpointsForDimension1_e, Autopilot_P.ScheduledGain_Table_p, 4U) +
    (Autopilot_U.in.data.Psi_magnetic_track_deg + Autopilot_P.Constant_Value_ef), Autopilot_P.Constant_Value_ef) -
                        (Autopilot_U.in.data.Psi_magnetic_track_deg + Autopilot_P.Constant3_Value_no)) +
                       Autopilot_P.Constant3_Value_no, Autopilot_P.Constant3_Value_no);
  Autopilot_Chart(rtb_Mod1_k, Autopilot_P.Gain_Gain_k4 * rt_modd(Autopilot_P.Constant3_Value_no - rtb_Mod1_k,
    Autopilot_P.Constant3_Value_no), Autopilot_P.Constant_Value_p1, &rtb_Minup, &Autopilot_DWork.sf_Chart_o);
  switch (static_cast<int32_T>(rtb_ManualSwitch)) {
   case 1:
    rtb_Mod1_k = rtb_out_k * look1_binlxpw(Autopilot_U.in.data.V_tas_kn,
      Autopilot_P.ScheduledGain_BreakpointsForDimension1, Autopilot_P.ScheduledGain_Table, 3U);
    break;

   case 2:
    rtb_Mod1_k = rtb_out_c * look1_binlxpw(Autopilot_U.in.data.V_tas_kn,
      Autopilot_P.ScheduledGain_BreakpointsForDimension1_n, Autopilot_P.ScheduledGain_Table_b, 3U);
    break;

   case 3:
    rtb_Mod1_k = rtb_out_a * look1_binlxpw(Autopilot_U.in.data.V_tas_kn,
      Autopilot_P.ScheduledGain_BreakpointsForDimension1_l, Autopilot_P.ScheduledGain_Table_k, 3U);
    break;

   case 4:
    rtb_Mod1_k = rtb_out_p * look1_binlxpw(Autopilot_U.in.data.V_tas_kn,
      Autopilot_P.ScheduledGain_BreakpointsForDimension1_lw, Autopilot_P.ScheduledGain_Table_g, 3U);
    break;

   case 5:
    rtb_Mod1_k = rtb_Minup * look1_binlxpw(Autopilot_U.in.data.V_tas_kn,
      Autopilot_P.ScheduledGain_BreakpointsForDimension1_j, Autopilot_P.ScheduledGain_Table_l, 3U);
    break;

   default:
    rtb_Mod1_k = Autopilot_P.Constant3_Value;
    break;
  }

  if (rtb_Mod1_k > rtb_ROLLLIM1) {
    rtb_Mod1_k = rtb_ROLLLIM1;
  } else {
    rtb_out_p = Autopilot_P.Gain1_Gain * rtb_ROLLLIM1;
    if (rtb_Mod1_k < rtb_out_p) {
      rtb_Mod1_k = rtb_out_p;
    }
  }
  ...
  rtb_out_p = rtb_Mod1_k - Autopilot_DWork.Delay_DSTATE_h;
  ...
  rtb_Sum_h = Autopilot_U.in.time.dt * Autopilot_P.LagFilter_C1_l;
  rtb_Minup = rtb_Sum_h + Autopilot_P.Constant_Value_a;
  Autopilot_DWork.Delay1_DSTATE_f = 1.0 / rtb_Minup * (Autopilot_P.Constant_Value_a - rtb_Sum_h) *
    Autopilot_DWork.Delay1_DSTATE_f + (Autopilot_DWork.Delay_DSTATE_h + Autopilot_DWork.Delay_DSTATE_j) * (rtb_Sum_h /
    rtb_Minup);
  rtb_out_p = static_cast<real_T>(rtb_out) - Autopilot_DWork.Delay_DSTATE_cq;
  ...
  Autopilot_DWork.Delay_DSTATE_cq += rtb_out_p;
  if (Autopilot_DWork.Delay_DSTATE_cq > Autopilot_P.Saturation_UpperSat_n) {
    rtb_Sum_p = Autopilot_P.Saturation_UpperSat_n;
  } else if (Autopilot_DWork.Delay_DSTATE_cq < Autopilot_P.Saturation_LowerSat_a) {
    rtb_Sum_p = Autopilot_P.Saturation_LowerSat_a;
  } else {
    rtb_Sum_p = Autopilot_DWork.Delay_DSTATE_cq;
  }

  rtb_Product_d = Autopilot_DWork.Delay1_DSTATE_f * rtb_Sum_p;
  rtb_Product1_c = (Autopilot_P.Constant_Value_cm - rtb_Sum_p) * rtb_ManualSwitch;
  Autopilot_Y.out.output.flight_director.Beta_c_deg = rtb_Mod1_b;
  Autopilot_Y.out.output.autopilot.Beta_c_deg = rtb_Mod1_b;
  Autopilot_Y.out.output.flight_director.Phi_c_deg = rtb_Mod1_k;
  if (Autopilot_DWork.is_active_c10_Autopilot == 0U) {
    ...
    switch (Autopilot_DWork.is_c10_Autopilot) {
     case Autopilot_IN_ALT_ACQ:
      rtb_Mod1_b = std::abs(Autopilot_U.in.data.ap_H_c_ft - Autopilot_U.in.data.H_ind_ft);
      if (rtb_Mod1_b <= 20.0) {
        Autopilot_DWork.is_c10_Autopilot = Autopilot_IN_ALT_HOLD;
        rtb_LAW = 1;
      } else if (rtb_Mod1_b > 1000.0) {
  ...
  if (Autopilot_DWork.IC_FirstOutputTime_h) {
    ...
    rtb_IC_o = Autopilot_P.IC_Value_o;
  } else {
    rtb_IC_o = rtb_kntoms_o;
  }

  rtb_ManualSwitch = Autopilot_P.DiscreteDerivativeVariableTs_Gain_m * Autopilot_U.in.data.V_ias_kn;
  rtb_ROLLLIM1 = (rtb_ManualSwitch - Autopilot_DWork.Delay_DSTATE_g) / Autopilot_U.in.time.dt * Autopilot_P.Gain3_Gain_f
    + Autopilot_U.in.data.V_ias_kn;
  rtb_Sum_p = Autopilot_U.in.time.dt * Autopilot_P.LagFilter1_C1;
  rtb_Sum_h = rtb_Sum_p + Autopilot_P.Constant_Value_f;
  Autopilot_DWork.Delay1_DSTATE_g = 1.0 / rtb_Sum_h * (Autopilot_P.Constant_Value_f - rtb_Sum_p) *
    Autopilot_DWork.Delay1_DSTATE_g + (rtb_ROLLLIM1 + Autopilot_DWork.Delay_DSTATE_l) * (rtb_Sum_p / rtb_Sum_h);
  rtb_out_p = Autopilot_DWork.Delay1_DSTATE_g - Autopilot_U.in.data.ap_V_c_kn;
  ...
  rtb_Sum_p = Autopilot_P.Gain1_Gain_bz * rtb_out_p;
  rtb_Mod1_k = Autopilot_P.Gain1_Gain_ea * Autopilot_U.in.data.alpha_deg;
  rtb_Mod1_b = Autopilot_U.in.data.bz_m_s2 * std::sin(rtb_Mod1_k);
  rtb_Mod1_k = std::cos(rtb_Mod1_k);
  rtb_Mod1_k *= Autopilot_U.in.data.bx_m_s2;
  rtb_Mod1_k = (rtb_Mod1_b + rtb_Mod1_k) * Autopilot_P.Gain_Gain_f2 * Autopilot_P.Gain_Gain_pi;
  rtb_out_p = Autopilot_P.Gain1_Gain_k0 * std::abs(Autopilot_P.Constant_Value_em) + std::abs(rtb_Mod1_k);
  if (rtb_out_p <= Autopilot_P.Constant1_Value_e) {
    rtb_out_p = Autopilot_P.Constant1_Value_e;
  }

  rtb_Mod1_b = std::abs(rtb_Sum_p);
  if (rtb_Mod1_b < rtb_out_p) {
    rtb_out_p = rtb_Mod1_b;
  }
  ...
  rtb_Sum1_g = rtb_Sum_p - rtb_out_p * rtb_Mod1_k * Autopilot_P.Gain_Gain_h4;
  rtb_Sum_p = Autopilot_P.kntoms_Gain_i * Autopilot_U.in.data.V_tas_kn;
  rtb_Mod1_b = std::sin((rtb_GainTheta - std::cos(Autopilot_P.Gain1_Gain_bm * rtb_GainTheta1) *
    Autopilot_U.in.data.alpha_deg) * Autopilot_P.Gain1_Gain_go) * rtb_Sum_p * Autopilot_P.msftmin_Gain_m;
  if (Autopilot_DWork.IC_FirstOutputTime_hq) {
    Autopilot_DWork.IC_FirstOutputTime_hq = false;
    rtb_Sum_p = Autopilot_P.IC_Value_j;
  }

  rtb_out_p = (Autopilot_P.Constant_Value_k - rtb_Mod1_b) * Autopilot_P.ftmintoms_Gain_f0 / rtb_Sum_p;
  ...
  if (Autopilot_DWork.IC_FirstOutputTime_n) {
    ...
    rtb_IC_i = Autopilot_P.IC_Value_i;
  } else {
    rtb_IC_i = rtb_kntoms_k;
  }

  rtb_out_k = Autopilot_P.DiscreteDerivativeVariableTs_Gain_l * Autopilot_U.in.data.nav_gs_error_deg;
  rtb_out_c = (rtb_out_k - Autopilot_DWork.Delay_DSTATE_j4) / Autopilot_U.in.time.dt * Autopilot_P.Gain3_Gain_o +
  ...
  rtb_Sum_h = rtb_Sum_p + Autopilot_P.Constant_Value_a0;
  Autopilot_DWork.Delay1_DSTATE_l = 1.0 / rtb_Sum_h * (Autopilot_P.Constant_Value_a0 - rtb_Sum_p) *
    Autopilot_DWork.Delay1_DSTATE_l + (rtb_out_c + Autopilot_DWork.Delay_DSTATE_e) * (rtb_Sum_p / rtb_Sum_h);
  ...
  if (Autopilot_DWork.IC_FirstOutputTime_l) {
    ...
    rtb_IC_jq = Autopilot_P.IC_Value_n;
  } else {
    rtb_IC_jq = rtb_kntoms_i;
  }

  rtb_out_a = Autopilot_P.DiscreteDerivativeVariableTs_Gain_lf * Autopilot_U.in.data.V_ias_kn;
  rtb_Minup = (rtb_out_a - Autopilot_DWork.Delay_DSTATE_p) / Autopilot_U.in.time.dt * Autopilot_P.Gain3_Gain_fd +
    Autopilot_U.in.data.V_ias_kn;
  rtb_Sum_p = Autopilot_U.in.time.dt * Autopilot_P.LagFilter1_C1_p;
  rtb_Sum_h = rtb_Sum_p + Autopilot_P.Constant_Value_be;
  Autopilot_DWork.Delay1_DSTATE_h = 1.0 / rtb_Sum_h * (Autopilot_P.Constant_Value_be - rtb_Sum_p) *
    Autopilot_DWork.Delay1_DSTATE_h + (rtb_Minup + Autopilot_DWork.Delay_DSTATE_n) * (rtb_Sum_p / rtb_Sum_h);
  rtb_Mod1_b = Autopilot_DWork.Delay1_DSTATE_h - Autopilot_U.in.data.V_c_srs_kn;
  if (rtb_Mod1_b > Autopilot_P.Saturation_UpperSat_nk) {
    rtb_Mod1_b = Autopilot_P.Saturation_UpperSat_nk;
  } else {
    if (rtb_Mod1_b < Autopilot_P.Saturation_LowerSat_h) {
      rtb_Mod1_b = Autopilot_P.Saturation_LowerSat_h;
    }
  }

  rtb_Sum_p = Autopilot_P.Gain1_Gain_p * rtb_Mod1_b;
  rtb_Mod1_k = Autopilot_P.Gain1_Gain_mv * Autopilot_U.in.data.alpha_deg;
  rtb_Mod1_b = Autopilot_U.in.data.bz_m_s2 * std::sin(rtb_Mod1_k);
  rtb_Mod1_k = std::cos(rtb_Mod1_k);
  rtb_Mod1_k *= Autopilot_U.in.data.bx_m_s2;
  rtb_Mod1_k = (rtb_Mod1_b + rtb_Mod1_k) * Autopilot_P.Gain_Gain_dj * Autopilot_P.Gain_Gain_c3;
  rtb_Mod1_b = Autopilot_P.Gain1_Gain_k4 * std::abs(Autopilot_P.Constant_Value_jb) + std::abs(rtb_Mod1_k);
  if (rtb_Mod1_b <= Autopilot_P.Constant1_Value_l) {
    rtb_Mod1_b = Autopilot_P.Constant1_Value_l;
  }

  rtb_Sum_h = std::abs(rtb_Sum_p);
  if (rtb_Sum_h < rtb_Mod1_b) {
    rtb_Mod1_b = rtb_Sum_h;
  }
  ...
  rtb_Mod1_k = rtb_Sum_p - rtb_Mod1_b * rtb_Mod1_k * Autopilot_P.Gain_Gain_hk;
  rtb_Sum_p = Autopilot_P.kntoms_Gain_f * Autopilot_U.in.data.V_tas_kn;
  rtb_Mod1_b = std::sin((rtb_GainTheta - std::cos(Autopilot_P.Gain1_Gain_a * rtb_GainTheta1) *
    Autopilot_U.in.data.alpha_deg) * Autopilot_P.Gain1_Gain_nc) * rtb_Sum_p;
  if (Autopilot_DWork.IC_FirstOutputTime_e) {
    Autopilot_DWork.IC_FirstOutputTime_e = false;
    rtb_Sum_p = Autopilot_P.IC_Value_p;
  }

  rtb_Mod1_b = (Autopilot_P.Constant_Value_in - Autopilot_P.msftmin_Gain_by * rtb_Mod1_b) *
    Autopilot_P.ftmintoms_Gain_fr / rtb_Sum_p;
  ...
  x[2] = Autopilot_P.Gain_Gain_cd * std::asin(rtb_Mod1_b) * Autopilot_P.Gain_Gain_js;
  if (Autopilot_P.ManualSwitch_CurrentSetting_b == 1) {
    rtb_Mod1_b = Autopilot_P.Constant_Value_j;
  } else {
    rtb_Mod1_b = rtb_LAW;
  }

  switch (static_cast<int32_T>(rtb_Mod1_b)) {
   case 1:
    rtb_out_p = (Autopilot_U.in.data.ap_H_c_ft - Autopilot_U.in.data.H_ind_ft) * Autopilot_P.Gain_Gain_f;
    ...
    rtb_out_p = (rtb_out_p - std::sin((rtb_GainTheta - std::cos(Autopilot_P.Gain1_Gain_g * rtb_GainTheta1) *
      Autopilot_U.in.data.alpha_deg) * Autopilot_P.Gain1_Gain_e) * rtb_kntoms * Autopilot_P.msftmin_Gain_f) *
      Autopilot_P.ftmintoms_Gain_b / rtb_IC;
    if (rtb_out_p > 1.0) {
      rtb_out_p = 1.0;
    } else {
      if (rtb_out_p < -1.0) {
    ...
    rtb_Sum_p = Autopilot_P.Gain_Gain_g * std::asin(rtb_out_p) * Autopilot_P.Gain_Gain_c1;
    break;

   case 2:
    rtb_Mod1_b = Autopilot_U.in.data.ap_H_c_ft - Autopilot_U.in.data.H_ind_ft;
    if (rtb_Mod1_b < 0.0) {
      rtb_out_p = -1.0;
    } else if (rtb_Mod1_b > 0.0) {
      rtb_out_p = 1.0;
    } else {
      rtb_out_p = rtb_Mod1_b;
    }

    rtb_out_p = ((Autopilot_P.Constant_Value_b * rtb_out_p + rtb_Mod1_b) * Autopilot_P.Gain_Gain_e - std::sin
                 ((rtb_GainTheta - std::cos(Autopilot_P.Gain1_Gain_ii * rtb_GainTheta1) * Autopilot_U.in.data.alpha_deg)
                  * Autopilot_P.Gain1_Gain_m) * rtb_kntoms_o * Autopilot_P.msftmin_Gain_n) *
      Autopilot_P.ftmintoms_Gain_f / rtb_IC_o;
    if (rtb_out_p > 1.0) {
      rtb_out_p = 1.0;
    } else {
      if (rtb_out_p < -1.0) {
    ...
    rtb_Sum_p = Autopilot_P.Gain_Gain_j * std::asin(rtb_out_p) * Autopilot_P.Gain_Gain_p;
    break;
   ...
   case 3:
    if (Autopilot_U.in.data.ap_H_c_ft - Autopilot_U.in.data.H_ind_ft > Autopilot_P.Switch_Threshold_k) {
      ...
      rtb_Sum_p = Autopilot_P.Gain_Gain_kw * std::asin(rtb_out_p) * Autopilot_P.Gain_Gain_bf;
   ...
   case 4:
    rtb_out_p = (Autopilot_U.in.data.ap_H_dot_c_ft_min - std::sin((rtb_GainTheta - std::cos(Autopilot_P.Gain1_Gain_k *
      rtb_GainTheta1) * Autopilot_U.in.data.alpha_deg) * Autopilot_P.Gain1_Gain_h) * rtb_kntoms_k *
                 Autopilot_P.msftmin_Gain_b) * Autopilot_P.ftmintoms_Gain_h / rtb_IC_i;
    if (rtb_out_p > 1.0) {
      rtb_out_p = 1.0;
    } else {
      if (rtb_out_p < -1.0) {
    ...
    rtb_Sum_p = Autopilot_P.Gain_Gain_m * std::asin(rtb_out_p) * Autopilot_P.Gain_Gain_ms;
    break;

   case 5:
    rtb_Sum_p = (Autopilot_U.in.data.ap_FPA_c_deg - (rtb_GainTheta - std::cos(Autopilot_P.Gain1_Gain_i * rtb_GainTheta1)
   ...
   case 7:
    if (rtb_on_ground > Autopilot_P.Switch_Threshold) {
      ...
      rtb_out_p = (rtb_kntoms_o - std::sin((rtb_GainTheta - std::cos(Autopilot_P.Gain1_Gain_b * rtb_GainTheta1) *
        Autopilot_U.in.data.alpha_deg) * Autopilot_P.Gain1_Gain_o) * rtb_kntoms_i * Autopilot_P.msftmin_Gain) *
        Autopilot_P.ftmintoms_Gain / rtb_IC_jq;
      if (rtb_out_p > 1.0) {
        rtb_out_p = 1.0;
      } else {
        if (rtb_out_p < -1.0) {
      ...
      rtb_Sum_p = Autopilot_P.Gain_Gain_i * std::asin(rtb_out_p) * Autopilot_P.Gain_Gain_k;
    }
    break;
  ...
  if (rtb_Sum_p > Autopilot_P.Constant1_Value_i) {
    ...
    rtb_Mod1_b = Autopilot_P.Gain1_Gain_el * Autopilot_P.Constant1_Value_i;
    if (rtb_Sum_p < rtb_Mod1_b) {
      rtb_Sum_p = rtb_Mod1_b;
    }
  }
  ...
  rtb_out_p = rtb_Sum_p - Autopilot_DWork.Delay_DSTATE_b;
  rtb_kntoms_o = Autopilot_P.Constant2_Value_h1 * Autopilot_U.in.time.dt;
  if (rtb_out_p < rtb_kntoms_o) {
    rtb_kntoms_o = rtb_out_p;
  }

  rtb_out_p = Autopilot_P.Gain1_Gain_kl * Autopilot_P.Constant2_Value_h1 * Autopilot_U.in.time.dt;
  if (rtb_kntoms_o > rtb_out_p) {
    rtb_out_p = rtb_kntoms_o;
  }

  Autopilot_DWork.Delay_DSTATE_b += rtb_out_p;
  rtb_Sum_h = Autopilot_U.in.time.dt * Autopilot_P.LagFilter_C1_g;
  rtb_Mod1_k = rtb_Sum_h + Autopilot_P.Constant_Value_ja;
  Autopilot_DWork.Delay1_DSTATE_a = 1.0 / rtb_Mod1_k * (Autopilot_P.Constant_Value_ja - rtb_Sum_h) *
    Autopilot_DWork.Delay1_DSTATE_a + (Autopilot_DWork.Delay_DSTATE_b + Autopilot_DWork.Delay_DSTATE_f) * (rtb_Sum_h /
    rtb_Mod1_k);
  rtb_out_p = static_cast<real_T>(rtb_out) - Autopilot_DWork.Delay_DSTATE_o;
  ...
  Autopilot_DWork.Delay_DSTATE_o += rtb_out_p;
  if (Autopilot_DWork.Delay_DSTATE_o > Autopilot_P.Saturation_UpperSat_f) {
    rtb_Sum_h = Autopilot_P.Saturation_UpperSat_f;
  } else if (Autopilot_DWork.Delay_DSTATE_o < Autopilot_P.Saturation_LowerSat_f) {
    rtb_Sum_h = Autopilot_P.Saturation_LowerSat_f;
  } else {
    rtb_Sum_h = Autopilot_DWork.Delay_DSTATE_o;
  }

  rtb_Mod1_b = Autopilot_DWork.Delay1_DSTATE_a * rtb_Sum_h;
  rtb_Sum_h = Autopilot_P.Constant_Value_g4 - rtb_Sum_h;
  rtb_Sum_h *= rtb_GainTheta;
  Autopilot_Y.out.output.autopilot.Theta_c_deg = rtb_Mod1_b + rtb_Sum_h;
  ...
  Autopilot_Y.out.output.autopilot.Phi_c_deg = rtb_Product_d + rtb_Product1_c;
  Autopilot_DWork.Delay_DSTATE = rtb_Saturation;
  Autopilot_DWork.Delay_DSTATE_c = rtb_Saturation1;
  Autopilot_DWork.icLoad = 0U;
  Autopilot_DWork.Delay_DSTATE_j = Autopilot_DWork.Delay_DSTATE_h;
  Autopilot_DWork.Delay_DSTATE_g = rtb_ManualSwitch;
  Autopilot_DWork.Delay_DSTATE_l = rtb_ROLLLIM1;
  Autopilot_DWork.Delay_DSTATE_j4 = rtb_out_k;
  Autopilot_DWork.Delay_DSTATE_e = rtb_out_c;
  Autopilot_DWork.Delay_DSTATE_p = rtb_out_a;
  Autopilot_DWork.Delay_DSTATE_n = rtb_Minup;
  Autopilot_DWork.icLoad_b = 0U;
  Autopilot_DWork.Delay_DSTATE_f = Autopilot_DWork.Delay_DSTATE_b;
}
...
void AutopilotModelClass::initialize()
{
  ...
  Autopilot_DWork.IC_FirstOutputTime_hq = true;
  Autopilot_DWork.IC_FirstOutputTime_n = true;
  Autopilot_DWork.IC_FirstOutputTime_l = true;
  Autopilot_DWork.IC_FirstOutputTime_e = true;
  Autopilot_DWork.Delay_DSTATE = Autopilot_P.DiscreteDerivativeVariableTs_InitialCondition;
  Autopilot_DWork.Delay_DSTATE_c = Autopilot_P.Delay_InitialCondition;
  Autopilot_DWork.Delay1_DSTATE = Autopilot_P.Delay1_InitialCondition;
  Autopilot_DWork.icLoad = 1U;
  Autopilot_DWork.Delay_DSTATE_j = Autopilot_P.Delay_InitialCondition_g;
  Autopilot_DWork.Delay1_DSTATE_f = Autopilot_P.Delay1_InitialCondition_n;
  Autopilot_DWork.Delay_DSTATE_cq = Autopilot_P.RateLimiterVariableTs_InitialCondition;
  Autopilot_DWork.Delay_DSTATE_g = Autopilot_P.DiscreteDerivativeVariableTs_InitialCondition_e;
  Autopilot_DWork.Delay_DSTATE_l = Autopilot_P.Delay_InitialCondition_h;
  Autopilot_DWork.Delay1_DSTATE_g = Autopilot_P.Delay1_InitialCondition_g;
  Autopilot_DWork.Delay_DSTATE_j4 = Autopilot_P.DiscreteDerivativeVariableTs_InitialCondition_h;
  Autopilot_DWork.Delay_DSTATE_e = Autopilot_P.Delay_InitialCondition_o;
  Autopilot_DWork.Delay1_DSTATE_l = Autopilot_P.Delay1_InitialCondition_m;
  Autopilot_DWork.Delay_DSTATE_p = Autopilot_P.DiscreteDerivativeVariableTs_InitialCondition_b;
  Autopilot_DWork.Delay_DSTATE_n = Autopilot_P.Delay_InitialCondition_l;
  Autopilot_DWork.Delay1_DSTATE_h = Autopilot_P.Delay1_InitialCondition_md;
  Autopilot_DWork.icLoad_b = 1U;
  Autopilot_DWork.Delay_DSTATE_f = Autopilot_P.Delay_InitialCondition_ll;
  Autopilot_DWork.Delay1_DSTATE_a = Autopilot_P.Delay1_InitialCondition_b;
  Autopilot_DWork.Delay_DSTATE_o = Autopilot_P.RateLimiterVariableTs_InitialCondition_p;
